		...
		*/
		resetData: function(msgFlag) {
			...
			tempNMData=[
				...
				['51',	'暴虐の魔獣「ステゴドン」',			'ヒュダトス・プレメレファス',		'56',	'',		'10.0',	'17.8',	'ステゴドン',			'ゾウ',			'ゾウ'		],
				...
				['56',	'異界の鍛冶王「キング・ゴルデマール」',		'不明',					'--',	'',		'99.9',	'99.9',	'',				'',			''		],
				['57',	'食妖植物「レウケー」',				'不明',					'--',	'',		'99.9',	'99.9',	'',				'',			''		],
				['58',	'業炎の獅子王「バロン」',			'不明',					'--',	'',		'99.9',	'99.9',	'',				'',			''		],
				['59',	'魔蛇の女王「ケートー」',			'不明',					'--',	'',		'99.9',	'99.9',	'',				'',			''		],
				['60',	'「バルデシオンアーセナル」調査支援',		'不明',					'--',	'',		'99.9',	'99.9',	'',				'',			''		],
				['60',	'未知なる脅威「オヴニ」',			'不明',					'--',	'',		'99.9',	'99.9',	'',				'',			''		],
				['',	'',						'',					'',	'',		'99.9',	'99.9',	'',				'',			''		],
				['',	'',						'',					'',	'',		'99.9',	'99.9',	'',				'',			''		],
				['',	'',						'',					'',	'',		'99.9',	'99.9',	'',				'',			''		],
				['',	'',						'',					'',	'',		'99.9',	'99.9',	'',				'',			''		],
