		...
		*/
		resetData: function(msgFlag) {
			...
			tempNMData=[
				...
				['54',	'孤高の狩人「フロストメーン」',			'ノーザン・タイガー',			'59',	'',		'7.1',	'26.7',	'フロストメーン',		'フロスト',		'メーン'	],
				['55',	'血濡れの妖妃「ダフネ」',			'ダーク・ヴォイドモンク',		'60',	'',		'25',	'16',	'ダフネ',			'ダフネ',		'ダフネ'	],
				['56',	'異界の鍛冶王「キング・ゴルデマール」',		'ヒュダトス・レイス',			'61',	'',		'35.2',	'25.1',	'キング・ゴルデマール',		'キング',		'マール'	],
				...
				['60',	'水晶の龍「プロヴェナンス・ウォッチャー」',	'クリスタルクロー',			'65',	'',		'32.7',	'19.7',	'プロヴェナンス・ウォッチャー',	'ウォッチャー',		'水晶竜'	],
				['',	'',						'',					'',	'',		'99.9',	'99.9',	'',				'',			''		],
				['',	'',						'',					'',	'',		'99.9',	'99.9',	'',				'',			''		],
				['',	'',						'',					'',	'',		'99.9',	'99.9',	'',				'',			''		],
				['',	'',						'',					'',	'',		'99.9',	'99.9',	'',				'',			''		],
