		...
		*/
		resetData: function(msgFlag) {
			...
			tempNMData=[
				...
				['58',	'業炎の獅子王「バロン」',			'ラボラトリー・ライオン',		'63',	'',		'32.5',	'24.7',	'バロン',			'バロン',		'バロン'	],
				['59',	'魔蛇の女王「ケートー」',			'デルピュネ',				'64',	'',		'36.4',	'13.4',	'ケートー',			'ケートー',		'ケートー'	],
			...
			tempNMList = [
				['カラマリ\\[(..):(..)\\]','NM01'],['カラマリ:(..):(..)','NM01'],['イカ\\[(..):(..)\\]','NM01'],
				['ゾウ\\[(..):(..)\\]','NM02'],['ゾウ:(..):(..)','NM02'],['ステゴドン\\[(..):(..)\\]','NM02'],['ステゴドン:(..):(..)','NM02'],['ステゴ\\[(..):(..)\\]','NM02'],['ステゴ:(..):(..)','NM02'],['ゾウ\\[(..):(..)\\]','NM02'],['象\\[(..):(..)\\]','NM02'],
				['モレク\\[(..):(..)\\]','NM03'],['モレク:(..):(..)','NM03'],['ウシ\\[(..):(..)\\]','NM03'],['牛\\[(..):(..)\\]','NM03'],
				['ピアサ\\[(..):(..)\\]','NM04'],['ピアサ:(..):(..)','NM04'],['鳥\\[(..):(..)\\]','NM04'],
				['フロストメーン\\[(..):(..)\\]','NM05'],['フロストメーン:(..):(..)','NM05'],['フロスト\\[(..):(..)\\]','NM05'],['フロスト:(..):(..)','NM05'],['メーン\\[(..):(..)\\]','NM05'],['メーン:(..):(..)','NM05'],['ﾒｪｰﾝ\\[(..):(..)\\]','NM05'],
				['ダフネ\\[(..):(..)\\]','NM06'],['ダフネ:(..):(..)','NM06'],
				['キング・ゴルデマール\\[(..):(..)\\]','NM07'],['キング・ゴルデマール:(..):(..)','NM07'],['キング\\[(..):(..)\\]','NM07'],['キング:(..):(..)','NM07'],['マール\\[(..):(..)\\]','NM07'],['マール:(..):(..)','NM07'],
				['レウケー\\[(..):(..)\\]','NM08'],['レウケー:(..):(..)','NM08'],['レウケ\\[(..):(..)\\]','NM08'],
				['バロン\\[(..):(..)\\]','NM09'],['バロン:(..):(..)','NM09'],['ライオン\\[(..):(..)\\]','NM10'],['虎\\[(..):(..)\\]','NM10'],
				['ケートー\\[(..):(..)\\]','NM10'],['ケートー:(..):(..)','NM10'],['ケート\\[(..):(..)\\]','NM10'],['蛇\\[(..):(..)\\]','NM10'],['ヘビ\\[(..):(..)\\]','NM10'],
				['プロヴェナンス・ウォッチャー\\[(..):(..)\\]','NM11'],['プロヴェナンス・ウォッチャー:(..):(..)','NM11'],['ウォッチャー\\[(..):(..)\\]','NM11'],['ウォッチャー:(..):(..)','NM11'],['水晶竜\\[(..):(..)\\]','NM11'],['水晶竜:(..):(..)','NM11'],['水晶\\[(..):(..)\\]','NM11'],
				...
				['([0-9]+):([0-9]+):[0-9]+.*カラマリ','NM01'],
				['([0-9]+):([0-9]+):[0-9]+.*ステゴドン','NM02'],
				['([0-9]+):([0-9]+):[0-9]+.*モレク','NM03'],
				['([0-9]+):([0-9]+):[0-9]+.*ピアサ','NM04'],
				['([0-9]+):([0-9]+):[0-9]+.*フロストメーン','NM05'],
				['([0-9]+):([0-9]+):[0-9]+.*ダフネ','NM06'],
				['([0-9]+):([0-9]+):[0-9]+.*キング・ゴルデマール','NM07'],
				['([0-9]+):([0-9]+):[0-9]+.*レウケー','NM08'],
				['([0-9]+):([0-9]+):[0-9]+.*バロン','NM09'],
				['([0-9]+):([0-9]+):[0-9]+.*ケートー','NM10'],
				['([0-9]+):([0-9]+):[0-9]+.*プロヴェナンス・ウォッチャー','NM11']
			];
