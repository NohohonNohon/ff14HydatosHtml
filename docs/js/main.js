		...
		*/
		resetData: function(msgFlag) {
			...
			tempNMData=[
				...
				['51',	'暴虐の魔獣「ステゴドン」',			'ヒュダトス・プレメレファス',		'56',	'',		'10.0',	'17.8',	'ステゴドン',			'ゾウ',			'ステゴドン'	],
				['52',	'落涙の君主「モレク」',				'バル・ヌルチュー',			'57',	'',		'8.1',	'20.8',	'モレク',			'モレク',		'モレク'	],
				['53',	'極彩色の怪鳥「ピアサ」',			'ヴィヴィット・ガストルニス',		'58',	'',		'6.2',	'14.5',	'ピアサ',			'ピアサ',		'ピアサ'	],
				['54',	'孤高の狩人「フロストメーン」',			'ノーザン・タイガー',			'59',	'',		'7.1',	'26.7',	'フロストメーン',		'フロスト',		'フロスト'	],
				['55',	'血濡れの妖妃「ダフネ」',			'ダーク・ヴォイドモンク',		'60',	'',		'25',	'16',	'ダフネ',			'ダフネ',		'ダフネ'	],
				['56',	'異界の鍛冶王「キング・ゴルデマール」',		'不明',					'--',	'',		'35.2',	'25.1',	'キング・ゴルデマール',		'キング',		'キング'	],
				['57',	'食妖植物「レウケー」',				'タイガーホーク',			'62',	'',		'37',	'26',	'レウケー',			'レウケー',		'レウケー'	],
				['58',	'業炎の獅子王「バロン」',			'ラボラトリー・ライオン',		'63',	'',		'35.2',	'25.1',	'バロン',			'バロン',		'バロン'	],
				['59',	'魔蛇の女王「ケートー」',			'デルピュネ',				'64',	'',		'37.3',	'13.9',	'ケートー',			'ケートー',		'ケートー'	],
				['60',	'水晶の龍「プロヴェナンス・ウォッチャー」',	'クリスタルクロー',			'65',	'',		'32.7',	'19.7',	'プロヴェナンス・ウォッチャー',	'ウォッチャー',		'ウォッチャー'	],
				['60',	'未知なる脅威「オヴニ」',			'',					'--',	'乱霊流',	'27.5',	'28.4',	'オヴニ',			'オヴニ',		'オヴニ'	],
				['',	'',						'',					'',	'',		'99.9',	'99.9',	'',				'',			''		],
				['',	'',						'',					'',	'',		'99.9',	'99.9',	'',				'',			''		],
				['',	'',						'',					'',	'',		'99.9',	'99.9',	'',				'',			''		],
				['',	'',						'',					'',	'',		'99.9',	'99.9',	'',				'',			''		],
			...
			tempNMList = [
				['カラマリ\\[(..):(..)\\]','NM01'],['カラマリ:(..):(..)','NM01'],
				['ステゴドン\\[(..):(..)\\]','NM02'],['ステゴドン:(..):(..)','NM02'],['ゾウ\\[(..):(..)\\]','NM02'],['ゾウ:(..):(..)','NM02'],
				['モレク\\[(..):(..)\\]','NM03'],['モレク:(..):(..)','NM03'],
				['ピアサ\\[(..):(..)\\]','NM04'],['ピアサ:(..):(..)','NM04'],
				['フロストメーン\\[(..):(..)\\]','NM05'],['フロストメーン:(..):(..)','NM05'],['フロスト\\[(..):(..)\\]','NM05'],['フロスト:(..):(..)','NM05'],
				['ダフネ\\[(..):(..)\\]','NM06'],['ダフネ:(..):(..)','NM06'],
				['キング・ゴルデマール\\[(..):(..)\\]','NM07'],['キング・ゴルデマール:(..):(..)','NM07'],['キング\\[(..):(..)\\]','NM07'],['キング:(..):(..)','NM07'],
				['レウケー\\[(..):(..)\\]','NM08'],['レウケー:(..):(..)','NM08'],
				['バロン\\[(..):(..)\\]','NM09'],['バロン:(..):(..)','NM09'],
				['ケートー\\[(..):(..)\\]','NM10'],['ケートー:(..):(..)','NM10'],
				['プロヴェナンス・ウォッチャー\\[(..):(..)\\]','NM11'],['プロヴェナンス・ウォッチャー:(..):(..)','NM11'],['ウォッチャー\\[(..):(..)\\]','NM11'],['ウォッチャー:(..):(..)','NM11'],
				['オヴニ\\[(..):(..)\\]','NM12'],['オヴニ:(..):(..)','NM12']
			];
